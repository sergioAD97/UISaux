			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item"><a href="phpUISaux/Estudiante/listarauxiliaturasest.php">Listar Auxiliaturas</a></li>
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="phpUISaux/Estudiante/listarauxiliaturasest.php">Listar Auxiliaturas</a></li>
