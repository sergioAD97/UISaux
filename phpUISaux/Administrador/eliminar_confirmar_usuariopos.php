...
{
	$idpos = $_POST['idpos'];
	$query_delete = mysqli_query($conn,"DELETE FROM postulaciones WHERE idpos =$idpos ");
...
if(empty($_REQUEST['id'])  )
{
	...
	$query = mysqli_query($conn,"SELECT p.aspirante, p.fecha_postulacion,p.fecha_dada_baja, p.estado,p.auxiliatura
	...
	<!-- Register -->
					...
					<div class="search_section d-flex flex-column align-items-center justify-content-center">
						...
						<div class="search_content text-center">
                            ...
                            <h1 class="search_title">Eliminar Postulacion</h1>
</div>
</div>
</div>
...
<div class="data_delete">
			...
			<p>Aspirante: <span><?php echo $aspirante; ?></span></p>
			<p>Fecha postulacion: <span><?php echo $fecha_postulacion; ?></span></p>
			<p>Fecha dada baja: <span><?php echo $fecha_dada_baja; ?></span></p>
			<p>Estado: <span><?php echo $estado; ?></span></p>
			<p>Auxiliatura: <span><?php echo $auxiliatura; ?></span></p>

			<form method="post" action="">
				<input type="hidden" name="idpos" value="<?php echo $idpos; ?>">
				<a href="Administrarpos.php" class="btn_cancel">Cancelar</a>
