	...
	<!-- Register -->
					...
					<div class="search_section d-flex flex-column align-items-center justify-content-center">
						...
						<div class="search_content text-center">
                            ...
                            <h1 class="search_title">Lista de Postulaciones</h1>
</div>
</div>
</div>
...
<a href="registro_postulacion.php" class="btn_new">Crear Postulacion</a>
		...
		<?php 
			...
			$query = mysqli_query($conn ,"SELECT p.idpos, p.aspirante, p.fecha_postulacion,p.fecha_dada_baja, p.estado,p.auxiliatura FROM postulaciones p  ORDER BY p.idpos ASC LIMIT $desde,$por_pagina 
				");
			...
			?>
				<tr>
					...
					<?php if($data["usuario"] != 'administrador'){ ?>
						|
