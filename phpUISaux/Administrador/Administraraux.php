...
<html lang="es">
<head>
<title>Administrar-Auxiliaturas</title>
<meta charset="utf-8">
...
<a href="registro_auxiliatura.php" class="btn_new">Crear Auxiliatura</a>
		...
		<?php 
			//Paginador
			$sql_registe = mysqli_query($conn ,"SELECT COUNT(*) as total_auxiliaturas FROM auxiliaturas  ");
			$result_register = mysqli_fetch_array($sql_registe);
			$total_registro = $result_register['total_auxiliaturas'];
			...
			$query = mysqli_query($conn ,"SELECT a.idaux, a.fecha_inicio, a.Administrativo_creador, a.estado, a.texto,a.auxiliar, a.fecha_finalizacion FROM auxiliaturas a  ORDER BY a.idaux ASC LIMIT $desde,$por_pagina 
				");
