				...
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="nav-item dropdown main_nav_item">
							...
							<a class="dropdown-item" href="Administrador/Administrar.php">Gestionar Usuarios</a>
							<a class="dropdown-item" href="Administrador/Administraraux.php">Gestionar Auxiliaturas</a>
							<a class="dropdown-item" href="Administrador/Administrarpos.php">Gestionar Postulaciones</a>
						</li>
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="perfil.php">Pefil</a></li>
