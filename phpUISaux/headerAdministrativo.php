				...
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="nav-item dropdown main_nav_item">
							...
							<a class="dropdown-item" href="phpUISaux/Administrativo/crear.php">Crear Auxiliaturas</a>
							<a class="dropdown-item" href="phpUISaux/listarauxiliaturas.php">Listar Auxiliaturas</a>
						</li>
				...
				<div class="row">
					...
					<div class="col-lg-4 hero_box_col">
						<div class="hero_box d-flex flex-row align-items-center justify-content-start">
							...
							<div class="hero_box_content">
								<h2 class="hero_box_title">Publicar auxiliatura</h2>
								<a href="phpUISaux/Administrativo/crear.php" class="hero_box_link">ver mas</a>
							</div>
						</div>
					</div>
