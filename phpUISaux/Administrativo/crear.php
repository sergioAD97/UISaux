				...
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item">
							...
							<a class="dropdown-item" href="crear.php">Crear Auxiliaturas</a>
	...
	<div class="register">
					...
					<div class="search_section d-flex flex-column align-items-center justify-content-center">
						...
						<div class="search_content text-center">
                            ...
                            <h1 class="search_title">Bienvenido, por favor a continuación haga una breve descripción de la auxiliatura a publicar</h1>
                            <form id="search_form" class="search_form" action="post">
								<textarea id="codigo" class="descripcion search_form_name" type="text" placeholder="ingrese aqui la información, máximo 400 caracteres." required="required" data-error="Se requiere codigo." maxlength="400"></textarea>
                                <button id="search_submit_button" type="submit" class="search_submit_button trans_200" value="Submit">Registrar</button>
							</form>
						</div> 
					</div>
